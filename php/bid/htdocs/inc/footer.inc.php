	...
	<aside>
		<nav>
			<h4>Navigation</h4>
			<ul>
				<li><a href="index.php">Current Auctions</a></li>
				<li><a href="login.php">Login</a></li>
				<li><a href="register.php">Register</a></li>
				<?php 
				if(isset($_SESSION[userId])){
				echo '<li><a href="createItem.php">Create Item</a></li>';
				}
				?>
		...
		<h4>About</h4>
		<div id="asideContent">
			<p>This is an auction site. blah blah blah.</p>
		</div>
	</aside>
</div>
		...
		<footer>
			...
			-->
			<p>Template Design &amp; Markup by <a href="http://jabz.net/contact/jonas-jacek">Jonas Jacek</a> | <a href="http://owmx.com/" title="Free HTML5 &amp; CSS3 Web Templates">Free Web Templates</a>.</p>
		</footer>
	</div>
	</body>
</html>