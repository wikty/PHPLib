...
<body>
	...
	{
		echo "<a href='adminoperator.php?action=addcat'>[Add-Category]</a>";
		echo "<a href='adminoperator.php?action=addforum'>[Add-Forum]</a>";
		echo "<a href='adminoperator.php?action=logout'>[LogOut]</a>";
	}
