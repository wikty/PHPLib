...
elseif(isset($_SESSION[admin]) && basename($_SERVER[SCRIPT_NAME])=='index.php')
{
echo '<div><a href="logout.php"><strong>Administrator-LogOut</strong></a></div>';
}
?>
   <div>
