<?php
 ...
 global $sv;
 $cmd="select movie_id,movie_name,movie_year,movie_director,
...
{   
  ...
  $table.=<<<herehtml
   <tr>
   <td><a href="movieInfo.php?movie_id=$movie_id"
   title="click here to find more information about this film-$movie_name">$movie_name</a></td>
   <td>$movie_year</td>
   <td>$director_name</td>
   <td>$actor_name</td>
   <td>$movietype</td>
